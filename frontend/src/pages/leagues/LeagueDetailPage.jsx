...
export default function LeagueDetailPage() {
  ...
  const content = tab === 'win-impact'
    ? winImpact === null ? <Loading /> : <><div className="section-head win-impact-heading"><div><small>WIN IMPACT</small><h2>승리기여도</h2><p>참석했을 때 팀 승률이 얼마나 달라졌는지 보여줍니다.</p></div><span className="section-note">최소 {winImpact?.minimumGames}경기</span></div><WinImpactList players={winImpact?.players} /></>
    : tab === 'standings'
